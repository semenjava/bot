...
/**
 * View helper for displaying  block objects.
 *
 * @package    View
 * @subpackage Helper
 */
class ViewHelperBlock extends ViewHelperBase
{
    /**
     ...
     *
     * @return Core_Block  The requested Block object.
     * @throws View_Exception
     */
        ...
        if (!isset($this->_blockCache[$hash])) {
            try {
                $this->_blockCache[$hash] = $GLOBALS['injector']
                    ->getInstance('Core_Factory_BlockCollection')
                    ->create()
